...
const projects = [
    ...
    },
    {
        id: 'project3',
        section: 'csfundamentals',
        name: 'Deque with Assembly',
        thumb: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvFBa3G11OUBYADP7ouSBgwiiRzSYorF4dfg&s',
        fullimg: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvFBa3G11OUBYADP7ouSBgwiiRzSYorF4dfg&s',
        imgalt: 'Project Image',
        description: '> A project demonstrating low-level programming concepts with Assembly.<br>> An implementation of a deque (double-ended queue) using Assembly language.', // سيتم تعبئته عشوائيًا
        linkname: 'GitHub',
        linkurl: 'https://github.com/essamelbakry/deque-assembly',
    },
    {
        id: 'project4',
        section: 'csfundamentals',
        ...
        fullimg: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvFBa3G11OUBYADP7ouSBgwiiRzSYorF4dfg&s',
        imgalt: 'Project Image',
        description: '> An HTTP server designed for educational purposes to understand web protocols.<br>> A lightweight HTTP server built from scratch to handle basic web requests. ', // سيتم تعبئته عشوائيًا
        linkname: 'GitHub',
        linkurl: 'https://github.com/essamelbakry/http-server',
    },
];
